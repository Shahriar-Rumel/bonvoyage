#include "drawControlsWindow.h"

void updateAnimationSpeedForControlsWindow()
{
...
void drawControlsWindowFunction()
{
    updateAnimationSpeedForControlsWindow();
    ...
    SDL_RenderCopy(app.rend, controlsList.tex, NULL, &controlsList.rect);
